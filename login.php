			...
			<div class="col-xs-12 col-sm-12 col-md-12">
				<div class="card card-custom">
					<div class="card-heading pt-5 pb-3 px-5">
						<h4>LOGIN TO IT&BI LIBRARY</h4>
						<p>Please enter your Username and Password below</p>
					</div>

					<div class="card-body pb-5 pt-0">
						<form class="form-horizontal" action="teslogin.php" method="POST">
							...
							<div class="form-group">
								<div class="col-md-12 p-0">
									<div class="form-label-group">
									    <input type="password" id="password" name="password" class="form-control px-4" placeholder="Password" required>
									    <label for="password" class="px-4 text-muted">Password</label>
									</div>
								</div>
							</div>
							<div class="forgot-pass px-1">
								<a href="changepassword.php" class="text-muted forgot-pass">Forgot password?</a>
							</div>
							<input type="submit" class="btn btn-login mt-4" name="submit" value="LOGIN">
						</form>
					</div>
				</div>
			</div>
