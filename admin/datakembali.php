					...
					<div class="col-md-12">
						<div><br>
							<ul class="breadcrumb m-0 mb-1">
								...
								<li class="breadcrumb-item"><a href="datakembali.php">DATA TRANSAKSI</a></li>
								...
								<div class="tab-content">
									<div role="tab-panel" class="tab-pane active" id="list">
										...
										<table id="data-table" class="table data">
											...
											<tbody>
												<?php 
													$query_mysql = mysqli_query($con, "SELECT * FROM tb_transaksi WHERE status='Kembali'")or die(mysqli_error());
													$nomor = 1;
												...
												<tr>
													...
													<td>
														<center>
														<a href="deletetransaksi.php?id_transaksi=<?php echo $data['id_transaksi'];?>" class="btn btn-default btn-sm btn-delete" type="submit" data-toggle="tooltip" data-placement="bottom" title="Edit" onclick="return confirm('Apakah kamu yakin ingin menghapus?')"><i class="fas fa-trash"></i></a>
														</center>
													</td>
												</tr>
												<?php 
