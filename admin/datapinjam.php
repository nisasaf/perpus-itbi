					...
					<div class="col-md-12">
						<div><br>
							<ul class="breadcrumb m-0 mb-1">
								...
								<li class="breadcrumb-item"><a href="datapinjam.php">DATA TRANSAKSI</a></li>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body p-4">
								<div class="alert alert-info"><a href="peminjaman.php" class="btn btn-warning btn-lg btn-add-data"><i class="fas fa-plus mr-2"></i>Tambah Data</a></div>
										...
										<table id="data-table" class="table data">
											...
											<tbody>
												<?php 
													...
													$query_mysql = mysqli_query($con, "SELECT * FROM tb_transaksi WHERE status='Pinjam'")or die(mysqli_error());
													$nomor = 1;
												...
												<tr>
													...
													<td>
														<a href="detailbuku.php?kd_buku=<?php echo $data['kd_buku'];?>" style="color: #b50502;">
															<?php echo $data['judul']; ?>
														</a>
													</td>
													<td>
													...
													<td><?php 
												            ...
												            if ($lambat>0) {
										                    	echo "<center><b><font color='red'>$lambat hari &nbsp | &nbsp(Rp. $biaya,- x $lambat) = Rp. $denda,-</font></b></center>";
										               	    	...
										               	    	echo "<center><b><font color='blue'> $lambat hari</font></b></center>";
												            }
										                ?>
										            </td>
													<td>
														<center>
														<a href="proses_kembali.php?hal=edit&id_transaksi=<?php echo $data['id_transaksi'];?>&kd_buku=<?php echo $data['kd_buku'];?>" class="btn btn-default btn-sm btn-return" type="submit" data-toggle="tooltip" data-placement="bottom" title="Pengembalian" onclick="return confirm('Apakah kamu yakin ingin mengembalikan buku?')"><i class="fas fa-undo"></i></a>
														<a href="proses_perpanjang.php?id_transaksi=<?php echo $data['id_transaksi']; ?>" class="btn btn-default btn-sm btn-extend" type="submit" data-toggle="tooltip" data-placement="bottom" title="Perpanjang" onclick="return confirm('Apakah kamu yakin ingin memperpanjang peminjaman buku?')"><i class="fas fa-infinity"></i></a>
														</center>
													</td>
												</tr>
												<?php 
