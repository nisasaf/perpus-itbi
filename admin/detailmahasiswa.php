					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body p-4">
								<div class="alert alert-info"><div class="btn btn-warning btn-lg btn-label"><i class="fas fa-user-graduate mr-2"></i>Detail Mahasiswa</div></div>
								<table id="example" class="table table-hover">
									<?php 
										$query = mysqli_query($con, "SELECT * FROM tb_mahasiswa WHERE nim='$_GET[nim]'");
				                   ...
				                   <div class="col-12 mb-4 text-center display-img-responsive">
				                    ...
				                    <tr>
				                        <td width="200" class="td-bold">NIM</td>
				                        <td width="585"><?php echo $data['nim']; ?></td>
				                        <td rowspan="8" class="display-img">
				                        	<div class="pull-right image">
				                            	<img src="../gambar/<?php echo $data['foto']; ?>" class="img-rounded" height="300" width="250" alt="User Image" />
				                            </div>
				                        </td>
				                    </tr>
				                    <tr>
					                    <td class="td-bold">Nama</td>
					                    <td><?php echo $data['nama']; ?></td>
				                    </tr>
				                    <tr>
					                    <td class="td-bold">Jenis Kelamin</td>
					                    <td><?php echo $data['jenis_kelamin']; ?></td>
				                    </tr>
				                    <tr>
					                    <td class="td-bold">Tempat Tanggal Lahir</td>
					                    <td><?php echo $data['ttl']; ?></td>
				                    </tr>
				                    <tr>
					                    <td class="td-bold">Jenjang Studi</td>
					                    <td><?php echo $data['jenjang']; ?></td>
				                    </tr>
				                    <tr>
					                    <td class="td-bold">Program Studi</td>
					                    <td><?php echo $data['prodi']; ?></td>
				                    </tr>	
				                    <tr>
					                    <td class="td-bold">Kelas</td>
					                    <td><?php echo $data['kelas']; ?></td>
				                    </tr>
				                    <tr>
					                    <td class="td-bold">Waktu</td>
					                    <td><?php echo $data['waktu']; ?></td>
				                    </tr>
				                    <tr>
					                    <td class="td-bold">Semester</td>
					                    <td colspan="2"><?php echo $data['semester']; ?></td>
				                    </tr>
				                    <tr>
					                    <td class="td-bold">E-Mail</td>
					                    <td colspan="2"><?php echo $data['email']; ?></td>
				                    </tr>
				                    <tr>
					                    <td class="td-bold">Alamat</td>
					                    <td colspan="2"><?php echo $data['alamat']; ?></td>
				                    </tr>
				                    <tr>
					                    <td class="td-bold">Nomor Handphone</td>
					                    <td colspan="2"><?php echo $data['nohp']; ?></td>
				                    </tr>
								</table>
								<div class="text-right">
				                	<a href="mahasiswa.php" class="btn btn-md btn-warning text-light btn-back"> Kembali <i class="fa fa-arrow-circle-right ml-2"></i></a>
				                </div>
							</div>	
						</div>
					</div>
