					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body p-4">
								<div class="alert alert-info"><a href="inputbuku.php" class="btn btn-warning btn-lg btn-add-data"><i class="fas fa-plus mr-2"></i>Tambah Data</a></div>
								<div class="tab-content">
									<div role="tab-panel" class="tab-pane active" id="list">
										...
										<table id="data-table" class="table data">
											...
											<tbody>
												<?php 
													$query_mysql = mysqli_query($con, "SELECT * FROM tb_buku")or die(mysqli_error());
													$nomor = 1;
												...
												<tr>
													...
													<td><?php echo $data['tahun']; ?></center></td>
													<td><?php echo $data['penerbit']; ?></td>
													<td><?php echo $data['stok']; ?></td>
													<td>
														<center>
														<a href="editbuku.php?kd_buku=<?php echo $data['kd_buku']; ?>" class="btn btn-default btn-sm btn-edit" type="submit" data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="fas fa-edit"></i></a>
														<a href="deletebuku.php?kd_buku=<?php echo $data['kd_buku'];?>" class="btn btn-default btn-sm btn-delete" type="submit" data-toggle="tooltip" data-placement="bottom" title="Hapus" onclick="return confirm('Apakah kamu yakin ingin menghapus?')"><i class="fas fa-trash"></i></a>
														</center>
													</td>
												</tr>
												<?php 
