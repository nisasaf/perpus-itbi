					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body p-4">
								<div class="alert alert-info"><a href="inputuser.php" class="btn btn-warning btn-lg btn-add-data"><i class="fas fa-plus mr-2"></i>Tambah Data</a></div>
								<div class="tab-content">
									<div role="tab-panel" class="tab-pane active" id="list">
										...
										<table id="data-table" class="table data">
											...
											<tbody>
												<?php 
													$query_mysql = mysqli_query($con, "SELECT * FROM tb_user")or die(mysqli_error());
													$nomor = 1;
												...
												<tr>
													...
													<td><center><img src="../gambar/<?php echo $data['foto']; ?>" class="rounded-circle" height="50" width="50"></center></td>
													<td><?php echo $data['level']; ?></td>
													<td>
														<center>
														<a href="edituser.php?id_user=<?php echo $data['id_user']; ?>" class="btn btn-default btn-sm btn-edit" type="submit" data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="fas fa-edit"></i></a>
														<a href="deleteuser.php?id_user=<?php echo $data['id_user'];?>" class="btn btn-default btn-sm btn-delete" type="submit" data-toggle="tooltip" data-placement="bottom" title="Hapus" onclick="return confirm('Apakah kamu yakin ingin menghapus?')"><i class="fas fa-trash"></i></a>
														</center>
													</td>
												</tr>
												<?php 
