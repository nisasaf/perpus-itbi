										...
										<table id="data-table" class="table data">
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<center>
														<a href="deleteabsensi.php?id_absensi=<?php echo $data['id_absensi'];?>" class="btn btn-default btn-sm btn-delete" type="submit" data-toggle="tooltip" data-placement="bottom" title="Hapus" onclick="return confirm('Apakah kamu yakin ingin menghapus?')"><i class="fas fa-trash"></i></a>
														</center>
													</td>
												</tr>
												<?php 
